  ...
  return (
    <StyledEducation id="Education">
      <div className="education-container">
        ...
        <p>Signal processing (sound, image, video), Software engineering principles, Computer security, Constraint programming, Databases, Computer graphics, Distributed systems, Video games.</p>
